...
The trabecular bone micrCT dataset used in the examples is part of the public collection of the Living Human Digital Library (LHDL) Project, a project financed by the European Commission (project number: `FP6-IST 026932 <https://cordis.europa.eu/project/id/026932>`_).
...
For info on the dataset see `here <http://projects.kmi.open.ac.uk/lhdl/>`_.
